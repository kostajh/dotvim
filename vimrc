fun SetupVAM()
	" YES, you can customize this vam_install_path path and everything still works!
          ...
          call vam#ActivateAddons(['fugitive', 'syntastic', 'command-t', 'ack', 'delimitMate', 'snipmate', 'snipmate-snippets', 'supertab', 'surround', 'taglist-plus', 'NERD_commenter', 'tlib', 'vim-addon-mw-utils', 'vim-addon-manager', 'trailing-whitespace'], {'auto_install' : 0})
