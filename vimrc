fun SetupVAM()
	" YES, you can customize this vam_install_path path and everything still works!
         ...
         call vam#ActivateAddons(['trailing-whitespace', 'The_NERD_tree', 'Solarized', 'scss-syntax', 'Sass', 'fugitive', 'syntastic', 'command-t', 'ack', 'delimitMate', 'snipmate', 'snipmate-snippets', 'supertab', 'surround', 'taglist-plus', 'The_NERD_commenter', 'tlib', 'vim-addon-mw-utils', 'vim-addon-manager'], {'auto_install' : 0})
